...
export default function CardService(props) {
  ...
  //     )
  return (
    <div className="flex justify-end flex-left bg-gray-100 bg-opacity-75 sm:flex-col h-full mx-12 py-6 my-4 sm:my-8 sm:text-center justify-center rounded-lg  cardt animate w-9/12 md:w-4/12 xl:w-3/12">
