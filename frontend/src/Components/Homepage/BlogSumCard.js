...
export default function BlogSumCard(props) {
  return (
    <div>
      <div class="bg-gray-300 bg-opacity-75 max-w-sm flex flex-col h-auto rounded overflow-hidden shadow-lg cardt animate w-64 sm:w-full mx-3 md:mx-10 xl:mx-16 xl:mb-5">
        <img
